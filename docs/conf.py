...
# -*- coding: utf-8 -*-
#
# experimentator documentation build configuration file, created by
# sphinx-quickstart on Mon Mar 31 09:26:26 2014.
#
...
from experimentator import __version__
...
project = 'experimentator'
copyright = '2013-{}, Henry S. Harrison'.format(date.today().year)
...
htmlhelp_basename = 'experimentatordoc'
...
latex_documents = [
  ('index', 'experimentator.tex', 'experimentator Documentation',
   'Henry S. Harrison', 'manual'),
]
...
man_pages = [
    ('index', 'experimentator', 'experimentator Documentation',
     ['Henry S. Harrison'], 1)
]
...
texinfo_documents = [
  ('index', 'experimentator', 'experimentator Documentation',
   'Henry S. Harrison', 'experimentator', 'One line description of project.',
   'Miscellaneous'),
]
